...
let en4 = sprites.create(img`
    ...
    . . . . f f . . f f . . . . 
    `, SpriteKind.Enemy)
tiles.placeOnTile(plyr1, tiles.getTileLocation(6, 9))
...
let food4 = sprites.create(img`
    ...
    . . . . . . . . . . . . c c . . 
    `, SpriteKind.Food)
tiles.placeOnTile(food1, tiles.getTileLocation(5, 11))
tiles.placeOnTile(food2, tiles.getTileLocation(4, 4))
tiles.placeOnTile(food3, tiles.getTileLocation(9, 5))
tiles.placeOnTile(food4, tiles.getTileLocation(14, 10))
foods = [
food1,
food2,
food3,
